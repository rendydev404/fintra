      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-[90px] right-4 left-4 sm:left-auto sm:right-6 sm:bottom-24 z-50 sm:w-[380px] h-[600px] max-h-[80vh] flex flex-col bg-background border shadow-2xl rounded-2xl overflow-hidden"
          >
            {/* Header */}
